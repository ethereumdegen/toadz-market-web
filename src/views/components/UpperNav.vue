<template>
  ...
  <nav role="navigation" class="w-full m-2 p-2 flex flex-row">
    ...
    <t-dropdown  class="w-full" >
      ...
      >
        <button
          class="flex text-md  p-2 m-1 mx-2 text-gray-900 items-center pr-3 bg-gray-300 focus:outline-none focus:shadow-solid transition duration-150 ease-in-out border-2 border-gray-200"
